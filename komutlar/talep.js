...
exports.run = (client, message, args) => {
 message.delete();
    message.guild.createChannel(`talep-açan-${message.author.username}`, 'text').then(ch => {
